...
def make_exe(dist):
    ...
    # python_config.run_command = "import mymodule"

    # Run a Python module as __main__ when the interpreter starts.
    python_config.run_module = "py_compose_key.app"

    # Run a Python file when the interpreter starts.
    # python_config.run_filename = "mymodule/main2.py"
    ...
    # exe.add_python_resources(exe.read_virtualenv("./venv"))
